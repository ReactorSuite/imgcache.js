...
(function ($) {
  ...
  ImgCache.cancelDownloads = function(){
	  console.log("ImgCache.cancelDownloads");
	  if(ImgCache.currentDownloads && ImgCache.currentDownloads.length > 0){
		  console.log("ImgCache.cancelDownloads - there are " + ImgCache.currentDownloads.length + " to cancel.");
		  for(var i = 0; i < ImgCache.currentDownloads.length; i++){
			  console.log("ImgCache.cancelDownloads - " + i);
			  ImgCache.currentDownloads[i].abort();
		  }
	  }
  }
